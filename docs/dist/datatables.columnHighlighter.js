/*!
 ...
 https://htmlextensions.evotec.xyz | MIT License | Build: 2026-02-19T09:39:31.347Z
*/
...
(function () {
  ...
  function parseDateByFormatHint(value, fmt) {
    ...
    var nums = numsRaw.map(function (x) {
  ...
  window.DataTablesColumnHighlighter = {
          ...
          try {
            if (table && table.columns && table.columns().header) {
              ...
              for (var hi = 0; hi < headerNodes.length; hi++) {
                headers.push(jQuery(headerNodes[hi]).text().trim());
              }
            }
          } catch (_) {
            /* noop */
    ...
    init: function (tableId, config, table) {
      ...
      var normalized = this.normalizeRules(
        tableId,
